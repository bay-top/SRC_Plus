...
4. [chatgpt/CUSTOM_GPT_SETUP.md](chatgpt/CUSTOM_GPT_SETUP.md)를 따라 전용 Custom GPT를 만들고, Telegram에서 받은 HTML과 `editorial.json`을 업로드한다. 작업 패킷에도 상세 Instructions 파일을 함께 보내므로 일반 ChatGPT 대화에서도 같은 지침을 첨부할 수 있다.
